...
def generate_answer(
    ...
    *,
    ...
    system_prompt = (
        ...
        "Если в вопросе упомянуты конкретные таблицы, рисунки или главы (например: «опиши рисунок 2.2, таблицу 2.1 и главу 1»), "
        "оформляй ответ отдельными подпунктами по каждому объекту в указанном порядке."
    )
